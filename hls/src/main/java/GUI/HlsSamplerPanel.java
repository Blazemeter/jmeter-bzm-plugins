...
public class HlsSamplerPanel  extends JPanel{
    ...
    private void initComponents() {
        ...
        //GroupLayout resFieldPanelLayout = new javax.swing.GroupLayout(resFieldPanel);
                        ...
                        .addGroup(videoPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(videoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(videoPanelLayout.createSequentialGroup()
                                                ...
                                                .addContainerGap()
                                                //.addGap(18, 18, 18)
                                                .addComponent(urlField).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        playOptionsLayout.setHorizontalGroup(
                playOptionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
//                        .addGroup(playOptionsLayout.createSequentialGroup()
        ...
        playOptionsLayout.setVerticalGroup(
                playOptionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(playOptionsLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(playOptionsLayout.createParallelGroup()
                                        .addComponent(rPlayVideoBtn))
...
//                                        .addComponent(bitsField)
        ...
        networkOptionsLayout.setVerticalGroup(
                networkOptionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(networkOptionsLayout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(networkOptionsLayout.createParallelGroup()
//                                        .addComponent(rAutoBtn)
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(playOptions, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(networkOptions, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addContainerGap()
                        ));
...
//                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(videoPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,javax.swing.GroupLayout.DEFAULT_SIZE)// Short.MAX_VALUE)
                                               .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(networkOptions, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(playOptions, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
//                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                                        .addComponent(videoPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addContainerGap())
...
public void setUrlData(String urlData) {urlField.setText(urlData);}
public String getUrlData () {return  urlField.getText();}

public void setResData(String resData) {resolField.setText(resData);}
public String getResData() {return resolField.getText();}

public void setNetData(String netData){bandwidthField.setText(netData);}
public String getNetData() {return bandwidthField.getText();}

public void setPlaySecondsData(String seconds) {playSecondsField.setText(seconds);}
public String getPlaySecondsData() {return playSecondsField.getText();}

public  void setVideoDuration (boolean check) {rPlayPartBtn.setSelected(check);}
public boolean getVideoDuration() {return rPlayPartBtn.isSelected();}

//public boolean getResolType(){
//    return rCustomResol.getModel() == resolGroup.getSelection();
//
//    }
...
public void setProtocol(String protocolValue) {jProtocolCombo.setSelectedItem(protocolValue);}
public String getProtocol() {return  jProtocolCombo.getSelectedItem().toString();}



//public void setHlsDuration (boolean check, String seconds){
//    rPlayVideoBtn.setSelected(check);
