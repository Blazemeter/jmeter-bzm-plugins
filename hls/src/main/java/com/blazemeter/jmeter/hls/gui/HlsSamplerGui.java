...
//    private JTextField playSecondsField;
    ...
    public String getStaticLabel() { return "HLS Sampler"; }
...
//        hlsSamplerPanel.setHlsDuration(sampler.getHlsDuration() != "" ? true : false, sampler.getHlsDuration());
...
//            sampler.setName(hlsSamplerPanel.getName());



//            sampler.setURLData(this.urlField.getText());
//            sampler.setResData(this.resField.getText());
//            sampler.setPlaySecondsData(this.playSecondsField.getText());
        }
