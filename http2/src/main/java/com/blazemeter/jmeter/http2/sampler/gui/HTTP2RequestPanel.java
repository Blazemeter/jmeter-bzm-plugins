...
public class HTTP2RequestPanel extends JPanel {
    ...
    public HTTP2RequestPanel(boolean showSamplerFields, boolean showImplementation, boolean showRawBodyPane) {
     ...
     */
    public HTTP2RequestPanel(boolean showSamplerFields, boolean showImplementation, boolean showRawBodyPane, boolean showFileUploadPane) {
    ...
    public void configure(TestElement el) {
        ...
        syncRequest.setSelected(el.getPropertyAsBoolean(HTTP2Request.SYNCREQUEST));
        //TODO agregate implementation selection
        /*if (showImplementation) {
            httpImplementation.setText(el.getPropertyAsString(HTTP2Request.IMPLEMENTATION));
        } */
    }
    ...
    public void modifyTestElement(TestElement element) {
        ...
        if (syncRequest.isSelected()) {
            element.setProperty(new BooleanProperty(HTTP2Request.SYNCREQUEST, true));
        } else {
            element.removeProperty(HTTP2Request.SYNCREQUEST);
        }
        //TODO aggregate implementation selection
        /*if (showImplementation) {
            element.setProperty(HTTP2Request.IMPLEMENTATION, httpImplementation.getText(),"");
        }*/
    }
